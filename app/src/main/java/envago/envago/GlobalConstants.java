...
/**
 * Created by vikas on 01-10-2016.
 */
public class GlobalConstants {
    public static String PREFNAME = "envago";
    ...
    public static String NUMBER_OF_DAY = "no.of.day";
    public static String IMAGEDATA = "image_data";
    public static String EVENT_PLACE = "event_place";
    public static String VALUE = "true";
    public static String EVENT_DESCRIPTION = "desc";
    public static String EVENT_DISCLAIMER = "disclaimer";
