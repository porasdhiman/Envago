...
public class StartingRouteActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener,
...
ImageView back_button_create;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.starting_route_layout);
