...
public class AccordingToCountryAdapter extends PagerAdapter {
    ...
    public AccordingToCountryAdapter(Context mContext, ArrayList<HashMap<String, String>> list) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        if(!list.get(position).get(GlobalConstants.EVENT_CAT_COUNT).equalsIgnoreCase("0")) {
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext, AccordingToCountry.class);
                    intent.putExtra(GlobalConstants.ID, list.get(position).get(GlobalConstants.country_id));
                    intent.putExtra(GlobalConstants.EVENT_NAME, list.get(position).get(GlobalConstants.NAME));
        ...
        cat_name_txtView.setText(list.get(position).get(GlobalConstants.NAME));
