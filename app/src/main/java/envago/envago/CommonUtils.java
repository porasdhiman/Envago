...
public class CommonUtils {
    ...
    public static long getRemainingTime(long timeofnotification){
	    ...
	    public static String UserID(Context c){
	    	SharedPreferences mSharedPreferences = c.getSharedPreferences(GlobalConstants.PREFNAME, Context.MODE_PRIVATE);
	    	return mSharedPreferences.getString(GlobalConstants.USERID, "");
